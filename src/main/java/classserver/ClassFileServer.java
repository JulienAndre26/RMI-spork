...
public class ClassFileServer extends ClassServer {
     ...
     *
     * @param path     the fqn of the class
     * @param archive the File that must be a jar or zip archive that may contain the class
     * @return the bytecodes for the class
     * @throws java.io.IOException if the class cannot be read
     */
     ...
     *
     * @param path     the fqn of the class
     * @param directory the File that must be a directory that may contain the class
     * @return the bytecodes for the class
     * @throws java.io.IOException if the class cannot be read
     */
