...
/**
 * The Class InfoService which allows to get statistics about the collection.
 */
public class InfoService extends UnicastRemoteObject implements
	 ...
	 * (non-Javadoc)
	 * 
	 * @see collection.interfaces.InfoServiceInterface#getDistantObjectsList()
	 */
	@Override
